...
curl -o /tmp/tcpa_packets_180619_1151.tar.gz https://d.kxxzz.com/sh/tcpa_packets_180619_1151.tar.gz
...
rpm -ivh https://d.kxxzz.com/sh/kernel-3.10.0-693.5.2.tcpa06.tl2.x86_64.rpm --force
